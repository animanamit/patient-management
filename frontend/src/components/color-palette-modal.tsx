  ...
  return (
    <>
      <Button
        ...
        className="fixed bottom-4 right-4 z-50 bg-lightest-gray"
      >
        ...
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            {colorPalette.map((color) => (
              <div
                key={color.name}
                className="bg-lightest-gray rounded-lg p-4"
              >
          ...
          <div className="mt-6 p-4 bg-muted rounded-lg">
            ...
            <ul className="text-sm text-muted-foreground space-y-1">
              ...
              <li>• Colors are defined as CSS custom properties in globals.css</li>
              <li>• Use semantic color names (primary, secondary, accent) for consistency</li>
            </ul>
          </div>
        </DialogContent>
      </Dialog>
