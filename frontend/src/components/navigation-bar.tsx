      ...
      <div className="px-4 sm:px-6">
        <div className="flex items-center justify-between h-12">
            ...
            {navigationItems.slice(1).map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`flex items-center gap-2 px-3 py-1.5 text-xs font-medium transition-colors rounded-xs ${
                    item.active
          ...
          <button
            ...
            className="md:hidden p-2 rounded-xs text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
          >
            {isMobileMenuOpen ? (
              <X className="h-4 w-4" />
            ) : (
              ...
              {navigationItems.slice(1).map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2 text-sm font-medium transition-colors rounded-xs ${
                      item.active
                        ? "bg-blue-50 text-blue-700 border border-blue-200"
